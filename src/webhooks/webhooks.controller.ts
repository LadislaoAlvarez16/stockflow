...
export class WebhooksController {
  ...
  getEvents() {
    return [
      {
        id: WebhookEventType.stock_low,
        description:
          'Se dispara cuando el stock de un producto cae por debajo o igual a su mínimo configurado.',
      },
      {
        id: WebhookEventType.stock_out,
        description: 'Se dispara cuando el stock de un producto llega a cero.',
      },
      {
        id: WebhookEventType.movement_created,
        description:
          'Se dispara cada vez que se registra un movimiento de stock (Inbound, Outbound, Transfer, Adjustment).',
      },
      {
        id: WebhookEventType.batch_expiring,
        description:
          'Se dispara cuando un lote está próximo a vencer según la configuración del sistema.',
      },
      {
        id: WebhookEventType.inventory_reconciled,
        description:
          'Se dispara al finalizar una sesión de inventario físico (sea exitosa o con errores).',
      },
    ];
  }
